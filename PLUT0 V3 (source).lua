...
infoTab:AddParagraph("update log!","v3.01 we have added a few things to the fun tab, including bug fixes.")
infoTab:AddParagraph("WARNING","use esp and fly at youre own risk, in some games that have high end anti cheats the ESP and FLY is easly detected, so if you get banned we are not responsible, but in most games it will work perfectly fine.")
